...
const MonthlyReportChannel = () => {
    ...
    useEffect(() => {
        const fetchInitialReport = async () => {
            setLoading(true);
            const finalApiURL = `${process.env.REACT_APP_REPORT_DASHBOARD_API_URL}/order/monthly/channel?channel=All`;
...
export default MonthlyReportChannel;