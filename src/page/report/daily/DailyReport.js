...
const DailyReport = () => {
    ...
    useEffect(() => {
        ...
        const fetchInitialReport = async () => {
            ...
            const finalApiURL = `${process.env.REACT_APP_REPORT_DASHBOARD_API_URL}/order/daily?channel=All&start_date=${formattedDate}&end_date=${formattedDate}&brand_name=Total`;
            const finalTotalApiURL = `${process.env.REACT_APP_REPORT_DASHBOARD_API_URL}/order/daily-total?channel=All&start_date=${formattedDate}&end_date=${formattedDate}&brand_name=Total`;
