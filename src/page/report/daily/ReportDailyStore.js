...
const ReportDailyStore = () => {
    ...
    useEffect(() => {
        ...
        const fetchInitialReport = async () => {
            ...
            const finalApiURL = `${process.env.REACT_APP_REPORT_DASHBOARD_API_URL}/order/daily/store?brand_name=All&start_date=${formattedDate}&end_date=${formattedDate}`;
            const finalTotalApiURL = `${process.env.REACT_APP_REPORT_DASHBOARD_API_URL}/order/daily-total/store?brand_name=All&start_date=${formattedDate}&end_date=${formattedDate}`;
    ...
    return (
        <>
            ...
            {loading ? (
                ...
                dataStatus ? <DailyReportTable reportData={reportInfo}/> :
...
export default ReportDailyStore;