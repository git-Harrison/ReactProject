...
import {
    ShopifyExcelSummaryList,
    ShopifyExcelSummaryUploadRequest
...
export const ShopifyExcelUpload = () => {
    ...
    const fetchData = async (yearMonth) => {
        try {
            const responseData = await ShopifyExcelSummaryList(yearMonth);
    ...
    const sendFileToServer = async (index) => {
        try {
            ...
            const responseData = await ShopifyExcelSummaryUploadRequest(file, year, selectedMonth, storeId);
    ...
    return (
        <>
            ...
            <div className="shopify_excel_upload_top">
                ...
                <div className="pagename_text">Summary</div>
                <span
